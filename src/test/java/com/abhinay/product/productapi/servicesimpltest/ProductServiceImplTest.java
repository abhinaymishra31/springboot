package com.abhinay.product.productapi.servicesimpltest;


import com.abhinay.product.productapi.customexceptions.ColorIsNullException;
import com.abhinay.product.productapi.customexceptions.SameColorUpdateException;
import com.abhinay.product.productapi.customexceptions.IdIsNullException;
...
//        verify(productRepository).findById(productExpected.getId()).orElse(null);
    ...
    public void productNotFoundTest()
    {
        ...
        when(productRepository.save(product)).thenReturn(product);
        assertThrows(ProductNotFoundException.class,()->productServiceImpl.updateProductColor(2l,newProductColor));
    }
